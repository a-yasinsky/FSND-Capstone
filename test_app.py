...
class HousingTestCase(unittest.TestCase):
    ...
    def test_housing_create(self):
        new_housing = {
            ...
            'room_types': [{'name': 'Single', 'price': 100}, {'name': 'Double',
                           'price': 200}],
            'contacts': {
    ...
    def test_housing_delete(self):
        res = self.client.delete(
            '/housing/{}'.format(housing_for_delete_id),
